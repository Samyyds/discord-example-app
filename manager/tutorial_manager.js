...
class Tutorial {
    constructor(interaction, client) {
        ...
        this.steps = [
            ...
            { text: "Type /look to inspect your surroundings. \nThis allows you to identify elements in the world in order to interact with them.", command: "1201779927050092614" },
            ...
            { text: "Type /talk Feleti to talk to him. \nYou can talk to most characters that you encounter. \nYou can try to /talk to things other than other people, but you may not get a response.", command: "1278618188665458709" },
            ...
            { text: "Type /map to see where you are. \nThe map will also show you areas that are connected to where you currently are. \nUse the map to navigate the world, and determine how to travel from one location to another.", command: "1200693908859006987" },
