...
class Tutorial {
    constructor(interaction, client) {
        ...
        this.steps = [
            ...
            { text: "Your character has been created. Click next to continue.", command: null },
